    ...
    <div className="flex w-full h-full absolute left-0 top-60 mb-10 pt-10 lg:pt-20 bg-[#f8f8f8] justify-center">
      <div className="bg-white rounded-lg xl:h-[80vh] flex gap-6 flex-wrap w-[60%] justify-between items-center p-14 pt-6 ">
        <div>
          ...
          <div className="border-dashed rounded-xl border-4 border-gray-200 flex-col justify-center items-center outline-none mt-10 w-[260px] h-[460px] p-10 cursor-pointer hover:border-red-300 hover:bg-gray-100 ">
            {isLoading ? (
              <p>Uploading</p>
            ) : (
              <div>
        ...
        <div className="flex flex-col gap-3 pb-10">
          ...
          <div className="flex gap-6 mt-10">
            ...
            <button
              onClick={handlePost}
              type="button"
              className=" bg-[#f51997] text-white text-md font-md p-2 rounded w-28 lg:w-44 outline-none"
            >
              Post
            </button>
          </div>
